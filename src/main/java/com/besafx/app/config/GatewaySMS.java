...
public class GatewaySMS {
    ...
    public Future<String> getCredit() throws JSONException {
        ...
        try {
            ...
            String data = URLEncoder.encode("user", "UTF-8") + "=" + URLEncoder.encode(options.getSmsUserName(), "UTF-8");
            data += "&" + URLEncoder.encode("password", "UTF-8") + "=" + URLEncoder.encode(options.getSmsPassword(), "UTF-8");
