...
public class SendSMS {
    ...
    public Future<String> getCredit() throws JSONException {
        ...
        vars.put("userName", options.getSmsUserName());
        vars.put("password", options.getSmsPassword());
    ...
    public Future<String> sendMessage(List<String> mobileList, String message) {
        ...
        JSONObject json = new JSONObject();
        CompanyOptions options = JSONConverter.toObject(Initializer.company.getOptions(), CompanyOptions.class);
        json.put("Username", options.getSmsUserName());
        json.put("Password", options.getSmsPassword());
