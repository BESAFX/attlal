...
public class Initializer implements CommandLineRunner {
    ...
    private void start() {
        ...
        if (Lists.newArrayList(companyService.findAll()).isEmpty()) {
            ...
            contact.setName("مؤسسة الأطلال الشمالية");
            ...
            company.setOptions(
                    JSONConverter.toString(
                            CompanyOptions.builder()
                                          ...
                                          .logo("---")
                                          .background("---")
                                          .reportTitle("مؤسسة الأطلال الشمالية")
                                          .reportSubTitle("لبيع وشراء الأجهزة الكهربائية والأجهزة المنزلية")
                                          .reportFooter("عرعر - حي الصالحية - شارع الأمير متعب بن عبد العزيز - س.ت: 3450171592 - رخصة: 390945671 - جوال: 0551138008")));
    ...
    private void init() {
        ...
        transactionTypeExpense = transactionTypeService.findByCode("Withdraw_Cash");
